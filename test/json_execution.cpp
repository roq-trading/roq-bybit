...
TEST_CASE("simple", "[json_execution]") {
  ...
  json::Execution obj{message, buffers};
...
TEST_CASE("parser", "[json_execution]") {
  ...
  struct Handler final : public json::Parser::Handler {
    ...
    void operator()(Trace<json::Execution2> const &event) override {
      found = true;
      auto &[trace_info, execution] = event;
      CHECK(execution.id == "6e2ab9ee56f4c6bb3dc788ba004a5054:663a60ba7623dfef:0:01"sv);
    }
